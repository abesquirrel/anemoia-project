...
<head>
    ...
    <meta name="description"
        content="@yield('description', 'Stepping through the frame into a sepia-tinted haze. Fine art photography based in Sibiu, Romania.')">
    ...
    <style>
        ...
        .gslide-description {
            ...
            /* Subtle blur for better legibility */
        }
