...
@section('content')
    ...
    <style>
        ...
        /* 2. The Floating Card (Transparent Glass Effect) */
        .login-card {
            /* Transparent dark background */
            background: rgba(0, 0, 0, 0.75);
            /* Blur the background image behind the card */
            backdrop-filter: blur(10px);
            -webkit-backdrop-filter: blur(10px);

            /* Subtle white border for the glass look */
        ...
        /* 3. Dark Inputs */
        .form-control-dark {
            background-color: rgba(255, 255, 255, 0.05); /* Semi-transparent inputs */
        ...
        .form-control-dark:focus {
            ...
            border-color: #64a19d; /* Theme accent */
            color: #fff;
        ...
        <div class="container px-4">
            ...
            <div class="d-flex justify-content-center">
                <div class="login-card fade-in-up">
                    ...
                    <h1 class="login-title">Anem[o]ia</h1>
                    <p class="login-subtitle">Sign in to sort memories</p>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            <div class="form-check">
                                ...
                                <label for="remember_me" class="form-check-label text-white-50 small">Remember me</label>
                            </div>

                            @if (Route::has('password.request'))
                                <a class="small text-white-50 text-decoration-none" href="{{ route('password.request') }}"
                                   style="transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,0.5)'">
                                    Forgot password?
                                </a>
                            @endif
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('home') }}" class="small text-white-50 text-decoration-none"
