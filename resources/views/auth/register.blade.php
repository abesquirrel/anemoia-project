...
@section('content')
    ...
    <style>
        ...
        .login-masthead {
            ...
            width: 100%;
            height: 100vh;
            min-height: 700px; /* SLightly taller for register form */
        ...
        <div class="container px-4">
            ...
            <div class="d-flex justify-content-center">
                <div class="login-card fade-in-up">
                    ...
                    <h1 class="auth-title">Join Anem[o]ia</h1>
                    <p class="auth-subtitle">Become a part of the memory</p>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="name" class="form-control form-control-dark rounded-1"
